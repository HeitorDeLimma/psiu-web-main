  ...
  return (
    <div className="w-screen h-screen flex bg-zinc-900">
      ...
      <div className="h-full w-2/5 relative flex items-center justify-center p-12">
        ...
        <div className="w-full bg-zinc-800 py-12 px-20 rounded-sm text-zinc-100">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <LogIn className="text-yellow-600" />
              <h1 className="text-2xl text-zinc-200">Faça seu login</h1>
            </div>
          ...
          <form className="mt-6 space-y-3">
            <div className="flex flex-col gap-1">
              ...
              <input
                id="ra"
                type="text"
                className="h-10 rounded-sm bg-transparent text-zinc-400 text-sm border-2 border-zinc-600 outline-none px-4 focus:border-yellow-500"
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full h-10 rounded-sm bg-transparent text-zinc-400 text-sm border-2 border-zinc-600 outline-none px-4 focus:border-yellow-500"
                />
            ...
            <div className="flex flex-col gap-3 items-center">
              <button className="w-full py-2 bg-yellow-500 rounded-md font-semibold text-zinc-900">
                ENTRAR
              </button>
